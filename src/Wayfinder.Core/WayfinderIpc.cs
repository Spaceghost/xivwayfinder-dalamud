...
/// <summary>A snapshot of what Wayfinder is doing, for <c>Wayfinder.GetState</c> and <c>/wayfinder status</c>.</summary>
...
/// <summary>
/// The IPC functions' argument checks and the JSON <c>Wayfinder.GetState</c> returns. Other plugins' input is
...
public static class WayfinderIpc
{
    ...
    /// <summary>
    /// Checks a <c>Wayfinder.SetTarget</c> call. <paramref name="territoryId"/> 0 means the player's current
