namespace Wayfinder.Shared;

/// <summary>
/// Dalamud IPC names: what Wayfinder publishes for sibling plugins (Ghostty's coordinate links, XivMcp, anything
...
public static class IpcContract
{
    ...
    /// </summary>
    public const string SetTarget = "Wayfinder.SetTarget";
    ...
    /// </summary>
    public const string SetMapTarget = "Wayfinder.SetMapTarget";

    /// <summary>() → bool. Forget the target set by IPC or command; true when there was one.</summary>
    public const string Clear = "Wayfinder.Clear";

    /// <summary>() → string. What Wayfinder is pointing at, as JSON (see docs/IPC.md).</summary>
    public const string GetState = "Wayfinder.GetState";

    // vnavmesh (github.com/awgil/ffxiv_navmesh, vnavmesh/IPCProvider.cs). Only queries: Wayfinder never calls the
