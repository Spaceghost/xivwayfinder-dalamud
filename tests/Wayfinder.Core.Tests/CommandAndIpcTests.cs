...
public sealed class CommandAndIpcTests
{
    ...
    {
        Assert.Equal("Wayfinder.SetTarget", IpcContract.SetTarget);
        Assert.Equal("Wayfinder.SetMapTarget", IpcContract.SetMapTarget);
        Assert.Equal("Wayfinder.Clear", IpcContract.Clear);
        Assert.Equal("Wayfinder.GetState", IpcContract.GetState);
